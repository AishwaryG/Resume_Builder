        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            ...
            <div>
                ...
                <div class="col-md-6">
                        ...
                        <input type="text" placeholder="Dev Ninja" name="resume_title" value="resume<?=time()?>" required class="form-control">
                    </div>
                    <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    <div class="col-md-6">
                        <label class="form-label"  >Full Name</label>
                        <input type="text" placeholder="Dev Ninja" name="full_name" required class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" placeholder="dev@abc.com" class="form-control" name="email_id" required>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1111111111" placeholder="9569569569" max="9999999999"
                            class="form-control" name="mobile_no" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" placeholder="Reading Books, Watching Movies" class="form-control" name = 
                        "hobbies" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Languages Known</label>
                        <input type="text" placeholder="Hindi,English" class="form-control" required name="languages">
                    </div>
